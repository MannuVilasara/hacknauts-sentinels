...
const AddServer = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(`${env.API_URL}/add/server`, formData, {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-foreground/90 text-sm space-y-2">
                      ...
                      <p>
                        2. <strong>IP Address:</strong> Enter the public IP address or domain name
                        where your server can be reached
                      </p>
                      <p>
                        3. <strong>Submit:</strong> Click &quot;Add Server&quot; to add it to your
