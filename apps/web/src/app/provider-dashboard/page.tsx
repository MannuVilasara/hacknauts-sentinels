    ...
    <div className="min-h-screen bg-background pt-16 relative">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-foreground mb-6">Provider Information</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-card/40 backdrop-blur-xl rounded-2xl p-6 border border-border">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-foreground">Provider Profile</h3>
                </div>
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-muted/20 text-muted-foreground capitalize">
              ...
              <div className="bg-card/40 backdrop-blur-xl rounded-2xl p-6 border border-border">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 bg-destructive/20 rounded-2xl flex items-center justify-center mr-4">
                    <svg
                  ...
                  <h3 className="text-lg font-semibold text-foreground">Security Reports</h3>
                </div>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground text-sm">Combined Reports</span>
                    <span className="text-foreground font-medium">{submittedReports.length}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground text-sm">Reports with Bug Data</span>
                    <span className="text-destructive font-medium">
                      {submittedReports.filter((r) => r.bugData).length}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground text-sm">Reports with Fix Data</span>
              ...
              <div className="bg-card/40 backdrop-blur-xl rounded-2xl p-6 border border-border">
                ...
                <div className="space-y-3">
                  <div className="text-center">
                    ...
                    <div className="text-muted-foreground text-sm">Services Protected</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-primary">99.9%</div>
                    <div className="text-muted-foreground text-sm">Uptime Maintained</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-muted-foreground">24h</div>
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-foreground mb-6">Security Reporting Center</h2>

            <div className="bg-card/40 backdrop-blur-xl rounded-2xl p-6 border border-border max-w-5xl mx-auto">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground">Submit Bug & Fix Report</h3>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full h-64 bg-background/50 border border-border rounded-lg p-4 text-foreground placeholder-muted-foreground resize-none font-mono text-sm focus:outline-none focus:border-red-400 focus:ring-1 focus:ring-red-400 transition-colors"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full h-64 bg-background/50 border border-border rounded-lg p-4 text-foreground placeholder-muted-foreground resize-none font-mono text-sm focus:outline-none focus:border-green-400 focus:ring-1 focus:ring-green-400 transition-colors"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="text-center">
                <button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-purple-700 hover:from-blue-700 hover:to-purple-800 text-foreground font-medium py-4 px-8 rounded-lg transition-all duration-200 flex items-center justify-center gap-3 mx-auto min-w-64"
                >
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-foreground mb-6">Submission History</h2>
                    ...
                    <tbody>
                      {submittedReports.slice(0, 10).map((report) => (
                        ...
                        >
                          ...
                          <td className="py-4 px-6 text-foreground/90 font-mono text-sm max-w-xs">
                            {report.bugData ? (
                              ...
                              <span className="text-muted-foreground italic">No bug data</span>
                            )}
                          </td>
                          <td className="py-4 px-6 text-foreground/90 font-mono text-sm max-w-xs">
                            {report.fixData ? (
                              ...
                              <span className="text-muted-foreground italic">No fix data</span>
                            )}
                          </td>
                        </tr>
                      ))}
